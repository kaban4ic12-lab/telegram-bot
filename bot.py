...
# =========================
SHOP = {
    "start_text": """🔥 Если ты здесь — ты в теме 🔥
🔞 Контент 18+ без фильтров
💯 Никакого фейка — только real
🎥 Сливы ТТ блогерш
🚫 Строго 18+ контент без блюра""",

    "info_text": """Есть 3 категории видео (про категории ниже) 👇

За приобретение 1 категории 🥇 у вас откроется доступ к тг каналу 📲,
в котором будет собрано контент 1 блогерши 👩‍💻
там будет много видео 🎥 как на 1 минуту, так и на 20 минут ⏱

За приобретение 2 категории 🥈 у вас откроется доступ к тг каналу 📲,
в котором будет собрано контент 4 блогерш 👩‍💻👩‍💻👩‍💻👩‍💻
видео также могут отличаться по времени ⏳ (более 40 видео) 🎬

За приобретение випки (3 категории) 💎🔞 у вас будет доступ ко всем видео блогерш 👑
(более 10 разных блогерш)

доступ к тг каналам 1 и 2 категории 📂""",
    "about_text": """Здесь ты приобретаешь всё анонимно 🕶
Любая информация о тебе остаётся строго между нами 🔒
Оплата и выдача материала проходят моментально ⚡
Бот полностью безопасный ✅
...
UQCXQ5gKftBpbd8SToXynLboUHtcErln5YTjcfnIrqBSXWfx""",
    ...
    "products": [
        {
            "id": "p1",
            "name": "🎬 Материал 1( больше в инфо )",
            "price": 1,
            "desc": "📦 1 видео",
            "image": "https://i.postimg.cc/7Y883BcR/photo-2-2026-04-21-17-00-53.jpg",
            "link": "https://t.me/+LCM8hn7QwXtlNWIy"
        },
        {
            "id": "p2",
            "name": "🎬 Материал 2( больше в инфо)",
            "price": 2,
            "desc": "📦 3 видео",
            "image": "https://i.postimg.cc/htvrfnr0/photo-3-2026-04-21-17-00-53.jpg",
...
async def pay(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.message.reply_text(
        "📸 Отправь скриншот оплаты и жди подтверждения",
